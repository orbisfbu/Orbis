...
static double const MAX_ICON_HEIGHT_AND_WIDTH = 50;
static double const MIN_ICON_HEIGHT_AND_WIDTH = 30;
...
- (void)viewDidLoad {
    ...
    [self.createEventButton setBackgroundColor:[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.7]];
    ...
    [self.exploreButton setBackgroundColor:[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.7]];
    ...
    [self.profileButton setBackgroundColor:[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.7]];
